...
from app.views import EventView, UserRegister, UserLogin, UserViewSet, UserLogout, UserView, home_view, admin_dashboard, edit_user, delete_user, user_detail, edit_event, delete_event, create_event
